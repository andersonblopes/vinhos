...
import com.spring.vinhos.model.TipoVinho;
import com.spring.vinhos.model.Vinho;
import com.spring.vinhos.repository.Vinhos;
import com.spring.vinhos.service.CadastroVinhoService;
...
public class VinhosController {
	...
	public ModelAndView salvar(@Valid Vinho vinho, BindingResult result, RedirectAttributes attributes) {
		...
		attributes.addFlashAttribute("mensagem", "Vinho cadastro com sucesso!");
